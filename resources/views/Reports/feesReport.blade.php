...
@section('headerScripts')
 ...
 <!-- Font Awesome -->
    ...
    <style>
        ...
        table.dataTable.dtr-inline.collapsed>tbody>tr.dtrg-group>td:first-child:before, table.dataTable.dtr-inline.collapsed>tbody>tr.dtrg-group>th:first-child:before{
                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class=" breadcrumb breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Fee Report</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="https://cdn.datatables.net/rowgroup/1.1.1/js/dataTables.rowGroup.min.js"
            type="text/javascript"></script>
    ...
    getFeeStatus(dtStart,dtEnd);
        ...
        function loadData(dtStart,dtEnd) {
            ...
            table = $('#footer-search').DataTable({
                ...
                "ajax":"/reports/generateSummarysheet/"+dtStart+"/"+dtEnd+"/"+$("#userId").val()+"/"+$( "#txtCourier option:selected" ).val()+"/"+$( "#txtPayment option:selected" ).val()+"/"+$( "#txtPatient option:selected" ).val()+"/"+$( "#txtFollowup option:selected" ).val()+"/"+$("#txtAppoType").val()+"/1",
                "columns": [
                     {"data": "paymentMode"},
                    {"data": "caseId"},
                    {"data": "customerName"},
                ...
                buttons: [
                    {
                        ...
                        "title": function () { return "Fee Report "+$('#dateFrom').val()+" - "+$('#dateTo').val(); },
                    },
                    {
                        "extend": 'excel',
                        "text": 'Excel',
